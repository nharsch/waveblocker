...
var G__26788 = o;
goog.object.set(G__26788,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__26811__delegate = function (args){
...
while (G__26812__i < G__26812__a.length) {G__26812__a[G__26812__i] = arguments[G__26812__i + 0]; ++G__26812__i;}
  args = new cljs.core.IndexedSeq(G__26812__a,0,null);
} 
return G__26811__delegate.call(this,args);};
...
return G__26811__delegate(args);
});
...
var G__26794 = o;
goog.object.set(G__26794,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__26816__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__26819__i < G__26819__a.length) {G__26819__a[G__26819__i] = arguments[G__26819__i + 0]; ++G__26819__i;}
  args = new cljs.core.IndexedSeq(G__26819__a,0,null);
} 
return G__26816__delegate.call(this,args);};
G__26816.cljs$lang$maxFixedArity = 0;
G__26816.cljs$lang$applyTo = (function (arglist__26821){
var args = cljs.core.seq(arglist__26821);
return G__26816__delegate(args);
});
...
var G__26795 = props;
var G__26795__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26795,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__26795);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26795__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4185__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__26796 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26796,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__26796;
}
})(),id_class);
...
var G__26797 = (cljs.core.count(argv) - first_child);
switch (G__26797) {
case (0):
...
var vec__26798 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26798,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26798,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26798,(2),null);
...
var temp__5739__auto___26833 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___26833 == null)){
} else {
var key_26834 = temp__5739__auto___26833;
(jsprops.key = key_26834);
}
...
var temp__5739__auto___26835 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___26835 == null)){
} else {
var key_26836 = temp__5739__auto___26835;
(jsprops.key = key_26836);
}
...
var temp__5739__auto___26841 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___26841 == null)){
} else {
var key_26842 = temp__5739__auto___26841;
(jsprops.key = key_26842);
}
...
var temp__5739__auto___26851 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___26851 == null)){
} else {
var key_26855 = temp__5739__auto___26851;
(jsprops.key = key_26855);
}
...
var temp__5739__auto___26856 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___26856 == null)){
} else {
var key_26857 = temp__5739__auto___26856;
(jsprops.key = key_26857);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26801_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__26801_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__26802 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26802,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26802,(1),null);
...
break;
default:
var G__26866 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__26867 = compiler;
v = G__26866;
compiler = G__26867;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template26808 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template26808 = (function (opts,id,fn_to_element,meta26809){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template26808.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_26810,meta26809__$1){
var self__ = this;
var _26810__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template26808(self__.opts,self__.id,self__.fn_to_element,meta26809__$1));
}));

(reagent.impl.template.t_reagent$impl$template26808.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_26810){
var self__ = this;
var _26810__$1 = this;
return self__.meta26809;
}));

(reagent.impl.template.t_reagent$impl$template26808.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template26808.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template26808.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template26808.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template26808.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta26809","meta26809",-1649714406,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template26808.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template26808.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template26808");

(reagent.impl.template.t_reagent$impl$template26808.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"reagent.impl.template/t_reagent$impl$template26808");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template26808.
 */
reagent.impl.template.__GT_t_reagent$impl$template26808 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template26808(opts__$1,id__$1,fn_to_element__$1,meta26809){
return (new reagent.impl.template.t_reagent$impl$template26808(opts__$1,id__$1,fn_to_element__$1,meta26809));
});

}

return (new reagent.impl.template.t_reagent$impl$template26808(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
