...
var G__46611 = o;
goog.object.set(G__46611,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__46683__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__46683 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__46684__i = 0, G__46684__a = new Array(arguments.length -  0);
while (G__46684__i < G__46684__a.length) {G__46684__a[G__46684__i] = arguments[G__46684__i + 0]; ++G__46684__i;}
  args = new cljs.core.IndexedSeq(G__46684__a,0,null);
} 
return G__46683__delegate.call(this,args);};
G__46683.cljs$lang$maxFixedArity = 0;
G__46683.cljs$lang$applyTo = (function (arglist__46685){
var args = cljs.core.seq(arglist__46685);
return G__46683__delegate(args);
});
...
var G__46634 = o;
goog.object.set(G__46634,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__46686__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__46687__i < G__46687__a.length) {G__46687__a[G__46687__i] = arguments[G__46687__i + 0]; ++G__46687__i;}
  args = new cljs.core.IndexedSeq(G__46687__a,0,null);
} 
return G__46686__delegate.call(this,args);};
G__46686.cljs$lang$maxFixedArity = 0;
G__46686.cljs$lang$applyTo = (function (arglist__46688){
var args = cljs.core.seq(arglist__46688);
return G__46686__delegate(args);
});
...
var G__46640 = props;
var G__46640__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46640,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__46640);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46640__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4185__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__46641 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46641,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__46641;
}
})(),id_class);
...
var G__46642 = (cljs.core.count(argv) - first_child);
switch (G__46642) {
case (0):
...
var vec__46644 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46644,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46644,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46644,(2),null);
...
var temp__5739__auto___46691 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___46691 == null)){
} else {
var key_46696 = temp__5739__auto___46691;
(jsprops.key = key_46696);
}
...
var temp__5739__auto___46698 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___46698 == null)){
} else {
var key_46699 = temp__5739__auto___46698;
(jsprops.key = key_46699);
}
...
var temp__5739__auto___46702 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___46702 == null)){
} else {
var key_46703 = temp__5739__auto___46702;
(jsprops.key = key_46703);
}
...
var temp__5739__auto___46706 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___46706 == null)){
} else {
var key_46707 = temp__5739__auto___46706;
(jsprops.key = key_46707);
}
...
var temp__5739__auto___46708 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___46708 == null)){
} else {
var key_46709 = temp__5739__auto___46708;
(jsprops.key = key_46709);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46660_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__46660_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__46663 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46663,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46663,(1),null);
...
break;
default:
var G__46717 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__46718 = compiler;
v = G__46717;
compiler = G__46718;
continue;
...
var G__46669 = tag;
var G__46669__$1 = (((G__46669 instanceof cljs.core.Keyword))?G__46669.fqn:null);
switch (G__46669__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template46674 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template46674 = (function (opts,id,fn_to_element,meta46675){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template46674.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_46676,meta46675__$1){
var self__ = this;
var _46676__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template46674(self__.opts,self__.id,self__.fn_to_element,meta46675__$1));
}));

(reagent.impl.template.t_reagent$impl$template46674.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_46676){
var self__ = this;
var _46676__$1 = this;
return self__.meta46675;
}));

(reagent.impl.template.t_reagent$impl$template46674.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template46674.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template46674.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template46674.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template46674.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta46675","meta46675",1907155256,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template46674.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template46674.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template46674");

(reagent.impl.template.t_reagent$impl$template46674.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"reagent.impl.template/t_reagent$impl$template46674");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template46674.
 */
reagent.impl.template.__GT_t_reagent$impl$template46674 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template46674(opts__$1,id__$1,fn_to_element__$1,meta46675){
return (new reagent.impl.template.t_reagent$impl$template46674(opts__$1,id__$1,fn_to_element__$1,meta46675));
});

}

return (new reagent.impl.template.t_reagent$impl$template46674(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
